...
import 'package:economiza2/modelo/bd/bd_configs.dart';
...
class BdCore {
  ...
  static final tableTipoManutencao = 'tipomanutencao';
  static final tableTipoCadastrar = 'tipocadastrar';
  ...
  Future _onCreate(Database db, int version) async {
    ...
    await db.execute('''
          ...
          ''');
    await db.execute('''
          CREATE TABLE $tableTipoManutencao(
            id INTEGER PRIMARY KEY AUTOINCREMENT,
            endereco TEXT ,
            numero TEXT,
            bairro TEXT ,
...
//aqui deu errado quando fui cadastrar login
  /*  await db.execute('''
          CREATE TABLE $tableTipoCadastrar (
            id INTEGER PRIMARY KEY AUTOINCREMENT,
            email TEXT ,
            senha TEXT ,
          )
